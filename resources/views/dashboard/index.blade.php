               ...
               <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                         <div class="logo">
                              ...
                              asset(
                                   'mazer/dist/assets/compiled/svg/logo.svg'
                              )
                         }}" alt="Logo" srcset="" />
                              </a>
                         </div>
                                                                 ...
                                                                 <td class="col-3">
                                                                      <div class="d-flex align-items-center">
                                                                           <div class="avatar avatar-md">
                                                                                <img src="{{
                                                                 asset(
                                                                      'mazer/dist/assets/compiled/jpg/5.jpg'
                                                                 )
                                                                 }}" />
                                                                           </div>
                                                                 ...
                                                                 <td class="col-3">
                                                                      <div class="d-flex align-items-center">
                                                                           <div class="avatar avatar-md">
                                                                                <img src="{{
                                                                 asset(
                                                                      'mazer/dist/assets/compiled/jpg/2.jpg'
                                                                 )
                                                                 }}" />
                                                                           </div>
                                                                           <p class="font-bold ms-3 mb-0">
                              ...
                              <div class="card-body py-4 px-4">
                                   <div class="d-flex align-items-center">
                                        <div class="avatar avatar-xl">
                                             <img src="{{
                                        asset(
                                             'mazer/dist/assets/compiled/jpg/1.jpg'
                                        )
                                   }}" alt="Face 1" />
                                        </div>
                                        <div class="ms-3 name">
                              ...
                              <div class="card-content pb-4">
                                   <div class="recent-message d-flex px-4 py-3">
                                        <div class="avatar avatar-lg">
                                             <img src="{{
                                        asset(
                                             'mazer/dist/assets/compiled/jpg/4.jpg'
                                        )
                                   }}" />
                                        </div>
                                        <div class="name ms-4">
