...
class HumanResourcesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('departments')->insert([
            ...
            [
                'name' => 'IT',
                'description' => 'Department Technology Information',
                'status' => 'active',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ...
        DB::table('tasks')->insert([
            [
                ...
                'assigned_to' => 1,
                'due_date' => Carbon::parse('2025-12-26'),
                'status' => 'pending',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ...
        DB::table('payroll')->insert([
            [
                ...
                'pay_date' => Carbon::parse(2025-12-26),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),                
            ],
            [
        ...
        DB::table('presences')->insert([
            [
                'employee_id' => 1,
                'check_in' => Carbon::parse('2025-12-1 09:00:00'),
                'check_out' => Carbon::parse('2025-12-1 16:00:00'),
                'date' => Carbon::parse('2025-12-1'),
                'status' => 'present',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),                
            ],
        ...
        DB::table('leave_requests')->insert([
            [
                ...
                'start_date' => Carbon::parse('2025-12-27'),
